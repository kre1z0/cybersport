...
const AnalyticIcon = ({isActive, ...props}) => (
    <SvgIcon {...props} viewBox="0 0 24 16">
        <path fill={isActive ? softGreen : null} d="M10.8,7.5c0.7-0.8,1.2-1.9,1.2-3C12,2,10,0,7.5,0S3,2,3,4.5c0,1.2,0.5,2.2,1.2,3C1.7,8.4,0,10.1,0,12.1v2.2
        ...
        <path fill={isActive ? strongSilver : null} d="M21,9.1c0.5-0.7,0.9-1.5,0.9-2.4c0-2.1-1.7-3.8-3.8-3.8s-3.8,1.7-3.8,3.8c0,2.1,1.7,3.8,3.8,3.8c0,0,0,0,0,0
