...
const ViewIcon = ({isVisible, ...props}) => (
    <SvgIcon {...props} viewBox="0 0 16 11.3">
        <path fill={isVisible ? softGreen : coolGreyTwo} d="M8,8.3c-1.5,0-2.7-1.2-2.7-2.7C5.3,4.2,6.5,3,8,3s2.7,1.2,2.7,2.7C10.7,7.1,9.5,8.3,8,8.3z M8,4.7c-0.6,0-1,0.4-1,1
		s0.4,1,1,1s1-0.4,1-1S8.5,4.7,8,4.7z"/>
        <path fill={isVisible ? softGreen : coolGreyTwo} d="M15.9,5.2C14.8,2.4,11.2,0,8,0C4.8,0,1.2,2.4,0.1,5.3c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0.1,0,0.1c0,0.1,0,0.1,0,0.2
