...
const ObjectsIcon = ({isActive, ...props}) => (
    <SvgIcon {...props} viewBox="0 0 24 22">
        <path fill={isActive ? strongSilver : null} d="M14,12l0,1.9c0,0,0,0.1,0,0.1h-4c0,0,0,0,0-0.1V12H8v1.9C8,14.6,8.5,16,9.6,16h4.8c1.1,0,1.6-1.4,1.6-2.1V12
		H14z"/>
        <path fill={isActive ? softGreen : null} d="M24,5.2C24,3.6,23.7,3,22,3h-5V1.5C17,0.7,16.3,0,15.4,0H8.6C7.7,0,7,0.7,7,1.5V3H2C0.3,3,0,3.6,0,5.2V7
