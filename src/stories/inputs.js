...
storiesOf('Inputs', [
        ...
        class WrapperAutoComplete extends React.Component {
            state = {
                data: [
                    'Иванов',
                    'Петров',
                    'ИванченкоИванченкоИванченкоИванченкоИванченкоИванченкоИванченкоИванченко',
                    'Иванов',
                    'Петров',
                    'Иванченко',
                    'Иванов',
    ...
    .add('SelectInput input', () => {
        class WrapperSelectFieldInput extends React.Component {
            state = {
                data: [
                    {
                        id: 1,
                        text: 'ИвановИвановИвановИвановИвановИвановИвановИвановИвановИвановИванов',
                    },
                    { id: 2, text: 'Петров' },
                    { id: 3, text: 'Сидоров' },
                ],
        ...
        return <WrapperSelectFieldInput />;
    })
