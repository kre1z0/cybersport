...
const Actions = (
  <div>
    <RoundedButton labelStyle={{textTransform: 'capitalize'}} label="Отменить"/>
    <RoundedButton labelStyle={{textTransform: 'capitalize'}} label="Сохранить" primary={true}/>
  </div>
);
        ...
        render() {
          return (
            <div>
              ...
              >
                <ObjectAddress attr={attrDefault}
                               object={object}
                />
              </ModalWindow>
            </div>
