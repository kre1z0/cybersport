import { COMMENTS_REQUEST, NUMBER_OF_COMMENTS } from '../../assets/const/youtube';
import {
...
export const getYoutubeComments = (id, token) => dispatch => {
    ...
    return fetch(url)
        ...
        .then(response => {
            dispatch(fetchCommentsByTokenSuccess(response));
        })
